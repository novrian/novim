...
let g:pdv_cfg_Author = "Novrian YF <me@novrian.info>"
" let g:pdv_cfg_Copyright = \"2013 (c) Novrian Y.F. All rights reserved.\"
let g:pdv_cfg_License = "GNU/GPL v2 {@link http://www.gnu.org/licenses/gpl-2.0.txt}"

" RS Awal Bros values
let g:pdv_cfg_Copyright = "2013 (c) RS Awal Bros. PT. Famon Global Medika, Indonesia."
